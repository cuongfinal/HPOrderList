...
public struct DataTableConfiguration: Equatable {
    ...
    public var heightForSectionFooter: CGFloat = CommonUtil.sizeBasedOnDeviceWidth(size: 48)
    public var heightForSectionHeader: CGFloat = CommonUtil.sizeBasedOnDeviceWidth(size: 48)
