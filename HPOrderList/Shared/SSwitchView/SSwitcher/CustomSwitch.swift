...
public class CustomSwitch: UIControl {
    ...
    @IBInspectable  public var padding: CGFloat = 1 {
        didSet {
            padding = CommonUtil.sizeBasedOnDeviceWidth(size: padding)
            self.layoutSubviews()
        }
    }
    ...
    @IBInspectable public var thumbSize: CGSize = CGSize.zero {
        didSet {
            thumbSize = CGSize(width: CommonUtil.sizeBasedOnDeviceWidth(size: thumbSize.width), height: CommonUtil.sizeBasedOnDeviceWidth(size: thumbSize.height))
            self.layoutSubviews()
        }
    }
